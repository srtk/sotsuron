...
深層信念ネットワークと共に、1次元のデータに対して広く用いることができるモデルが、積層雑音除去自己符号器(積層雑音除去自己符号器)である。これは2007年に提唱された積層自己符号器(積層自己符号器)\cite{bengio2007greedy}というモデルを基に、2008年に発表された\cite{vincent2008extracting}。基本的なアイデアは、深層信念ネットワークにおけるRBMを、雑音除去自己符号器という別のモデルに変更することである。
\subsubsection{自己符号器}
